...
demos.Collection = Backbone.Collection.extend({
	...
	// Send request to api.github.com/repos/bstone-demo-pack
...
$( document ).ready( function() {
	...
	$( ".filter-links li" ).each(function( index ) {
